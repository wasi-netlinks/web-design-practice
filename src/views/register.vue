      ...
      <div class="form-wrapper bg-white p-10 m-auto w-96 shadow">
        ...
        <form action="#" class="flex flex-col gap-5 justify-center items-center">
          ...
          <input
            ...
            class="w-full px-3 py-2 m-2 border-b-2 border-gray-400 focus:outline-none placeholder:text-gray-300 placeholder:px-none"
          />
          ...
          <input
            ...
            name="email"
            placeholder="E-mail"
            class="w-full px-3 py-2 m-2 border-b-2 border-gray-400 focus:outline-none placeholder:text-gray-300"
          />
          ...
          <button
            type="submit"
            class="w-full mt-5 px-3 py-2 bg-sky-600 text-white hover:bg-sky-700 active:bg-sky-900"
          >
            Register
          </button>
        </form>
